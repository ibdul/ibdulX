...
<header class="container max-w-5xl">
	<nav class="flex justify-between items-center py-5">
		...
		<ul class="inline-flex items-center justify-center">
			...
			<li class="header-link invisible">
				<button
					class="p-2 rounded-full w-8 h-8 overflow-hidden group hover:-rotate-45 transition-all"
					on:click={toggleDarkMode}
				>
					<div class="flex w-10 gap-2 dark:-translate-x-6 transition-all duration-300 ease-in-out">
